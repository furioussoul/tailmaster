...
public enum URLEnum {
    ...
    QR_CODE_URL(BASE_URL.url+"/qrcode/","初始化URL"),
	...
	WEB_WX_REMARK_NAME("%s/webwxoplog?lang=zh_CN&pass_ticket=%s", "修改好友备注"),
    WEB_WX_VERIFY_USER("%s/webwxverifyuser?r=%s&lang=zh_CN&pass_ticket=%s", "被动添加好友"),
